...
if __name__ == "__main__":
    ...
    for scenario in scenarios:
        ...
        for key, value in datasets.items():
            ...
            plt.tight_layout()
            plt.savefig(save_path + 'fpca_dmap_full_knowledge_mia_roc_curve_{scenario}_{key}.png', dpi=300)
            plt.close()
            ...
            plt.grid(True, linestyle=':', alpha=0.6)
            plt.tight_layout()
            plt.savefig(save_path + 'fpca_umap_full_knowledge_mia_roc_curve_{scenario}_{key}.png', dpi=300)
            plt.close()
            ...
            plt.grid(True, linestyle=':', alpha=0.6)
            plt.tight_layout()
            plt.savefig(save_path + 'fpca_kpca_full_knowledge_mia_roc_curve_{scenario}_{key}.png', dpi=300)
            plt.close()