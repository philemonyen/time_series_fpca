...
if __name__ == "__main__":
    ...
    # Apply Real FPCA on Validation Datasets
    ...
    optimal_k_mode_collapse = find_optimal_k(mode_collapse_scores)
    ...
    ig_low_fidelity = internal_geometry(isomap_real.dist_matrix_, isomap_low_fidelity.dist_matrix_)
    ...
    ig_mode_collapse = internal_geometry(isomap_real.dist_matrix_, isomap_mode_collapse.dist_matrix_)
    ...
    ig_exact_memorization = internal_geometry(isomap_real.dist_matrix_, isomap_exact_memorization.dist_matrix_)
    ...
    ## Low Utility Dataset
    print(f"Low Utility Isomap Optimal k: {optimal_k_low_fidelity}, Optimal dim: {optimal_dim_low_fidelity}")
    low_fidelity_aligned_fd.plot()
    plt.xlabel("Time (s)")
    plt.ylabel("Voltage (mV)")
    plt.title("Smoothed Aligned Low Fidelity Signal")
    plt.savefig(save_path + "smoothed_low_fidelity.png")
    plt.close()
    
    column = ["Metric", "Score"]
    table = [
        ["MMD", mmd_low_fidelity], 
        ["Frechet Wasserstein", fw_low_fidelity], 
        ["Covariance Distance", covariance_dist_low_fidelity], 
        ["Gromov Wasserstein", gw_low_fidelity],
        ["Internal Geometry", ig_low_fidelity],
    ]
    print("Low Utility Results")
    print(tb.tabulate(table, headers=column, tablefmt="grid"))
    column = ["Kolmogorov Smirnov", "Score"]
    table = [
        [f"FPC {i+1}", ks_test_low_fidelity[i]] for i in range(n_components)
    ]
    print(tb.tabulate(table, headers=column, tablefmt="grid"))
    ...
    plt.title("PRDC")
    plt.legend()
    plt.savefig(save_path + "PRDC_low_fidelity.png")
    plt.close()
    ...
    plt.legend()
    plt.savefig(save_path + "Local_Mixing_Ratio_low_fidelity.png")
    plt.close()

    ## Mode Collapse Dataset
    print(f"Mode Collapse Isomap Optimal k: {optimal_k_mode_collapse}, Optimal dim: {optimal_dim_mode_collapse}")
    mode_collapse_aligned_fd.plot()
    plt.xlabel("Time (s)")
    plt.ylabel("Voltage (mV)")
    plt.title("Smoothed Aligned Mode Collapse Signal")
    plt.savefig(save_path + "smoothed_mode_collapse.png")
    plt.close()
    
    column = ["Metric", "Score"]
    table = [
        ["MMD", mmd_mode_collapse], 
        ["Frechet Wasserstein", fw_mode_collapse], 
        ["Covariance Distance", covariance_dist_mode_collapse], 
        ["Gromov Wasserstein", gw_mode_collapse],
        ["Internal Geometry", ig_mode_collapse],
    ]
    print("Mode Collapse Results")
    print(tb.tabulate(table, headers=column, tablefmt="grid"))
    column = ["Kolmogorov Smirnov", "Score"]
    table = [
        [f"FPC {i+1}", ks_test_mode_collapse[i]] for i in range(n_components)
    ]
    print(tb.tabulate(table, headers=column, tablefmt="grid"))
    ...
    plt.title("PRDC")
    plt.legend()
    plt.savefig(save_path + "PRDC_mode_collapse.png")
    plt.close()
    ...
    plt.title("Local Mixing Ratio")
    plt.legend()
    plt.savefig(save_path + "Local_Mixing_Ratio_mode_collapse.png")
    plt.close()

    ## Exact Memorization Dataset
    print(f"Exact Memorization Isomap Optimal k: {optimal_k_exact_memorization}, Optimal dim: {optimal_dim_exact_memorization}")
    exact_memorization_aligned_fd.plot()
    plt.xlabel("Time (s)")
    plt.ylabel("Voltage (mV)")
    plt.title("Smoothed Aligned Exact Memorization Signal")
    plt.savefig(save_path + "smoothed_exact_memorization.png")
    plt.close()
    
    column = ["Metric", "Score"]
    table = [
        ["MMD", mmd_exact_memorization], 
        ["Frechet Wasserstein", fw_exact_memorization], 
        ["Covariance Distance", covariance_dist_exact_memorization], 
        ["Gromov Wasserstein", gw_exact_memorization],
        ["Internal Geometry", ig_exact_memorization],
    ]
    print("Exact Memorization Results")
    print(tb.tabulate(table, headers=column, tablefmt="grid"))
    column = ["Kolmogorov Smirnov", "Score"]
    table = [
        [f"FPC {i+1}", ks_test_exact_memorization[i]] for i in range(n_components)
    ]
    print(tb.tabulate(table, headers=column, tablefmt="grid"))
    ...
    plt.title("PRDC")
    plt.legend()
    plt.savefig(save_path + "PRDC_exact_memorization.png")
    plt.close()
    ...
    plt.title("Local Mixing Ratio")
    plt.legend()
    plt.savefig(save_path + "Local_Mixing_Ratio_exact_memorization.png")
    plt.close()